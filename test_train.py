...
########## Training Detector ###############################
#detect_basepath = train_tools.train_synth_detector(alphabet_dimensions, dimension_fonts, samples = 1500, epochs =5, batch_size=8, basepath = 'edocr2/models')
...
########## Training Recognizer #############################
'''recog_basepath = train_tools.train_synth_recognizer(alphabet_dimensions, dimension_fonts, samples = 35000, epochs = 10, batch_size=256, basepath = 'edocr2/models')
